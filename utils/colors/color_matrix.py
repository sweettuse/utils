...
class ColorMatrix(List[List[RGB]]):
    ...
    @classmethod
    def from_colors(cls, colors: List[RGB], shape: Shape = (8, 8)):
    ...
    @property
    def by_coords(self) -> Tuple[RC, RGB]:
    ...
    def strip(self, strip_color: Optional[RGB] = None) -> 'ColorMatrix':
    ...
    def split(self, split_color: Optional[RGB] = None) -> List['ColorMatrix']:
        """
    ...
    def find_all(self, color: Union[RGB, Set[RGB]]):
        s = slice(0, 3)
